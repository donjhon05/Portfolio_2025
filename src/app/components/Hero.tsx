  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <BackgroundGraphics intensity={0.4} />
      </div>
        ...
        <div className={`grid lg:grid-cols-2 gap-8 lg:gap-16 items-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            <div className="space-y-4 sm:space-y-6">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-linear-to-r from-cyan-50 to-purple-100 dark:from-cyan-900/30 dark:to-purple-800/30 border border-cyan-200 dark:border-cyan-700/50 rounded-full animate-fade-in hover:shadow-lg transition-all duration-300">
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-8xl font-black leading-none tracking-tighter">
                <span className="block text-black dark:text-white animate-slide-up drop-shadow-md">Hi, I'm</span>
                <span className="block bg-linear-to-r from-cyan-500 via-purple-600 to-pink-500 dark:from-cyan-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent animate-slide-up delay-100 hover:scale-110 transition-transform duration-500 drop-shadow-lg">
                  DJ Magarro
                </span>
              </h1>
              ...
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-black dark:text-white h-10 sm:h-12 md:h-14 font-semibold">
                ...
                <span className="mx-1 sm:mx-2 bg-linear-to-r from-cyan-600 to-purple-600 dark:from-cyan-400 dark:to-purple-400 bg-clip-text text-transparent">{displayText}</span>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center lg:justify-start">
              <a
                href="#projects"
                className="group relative inline-flex items-center justify-center gap-2 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg overflow-hidden transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 active:scale-95 bg-linear-to-r from-blue-500 to-purple-600 shadow-lg shadow-blue-500/30 hover:shadow-2xl"
              >
                <span className="absolute inset-0 bg-linear-to-r from-transparent via-white to-transparent opacity-0 group-hover:opacity-20 group-hover:animate-pulse"></span>
              ...
              >
                <span className="absolute inset-0 bg-linear-to-r from-blue-500 to-purple-500 opacity-0 group-hover:opacity-5 transition-opacity"></span>
          ...
          <div className="flex justify-center lg:justify-end mt-8 lg:mt-0">
            <div className="relative group">
              <div className="absolute -inset-2 sm:-inset-4 bg-linear-to-r from-blue-400 to-blue-600 dark:from-blue-500 dark:to-blue-400 rounded-2xl sm:rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-500 animate-pulse-slow"></div>
